...
<div id="666">
<center>
<table id='thirdtable' border='1' width = '400'><caption><h3>附加品信息表</h3></caption>
    <tr><td>物品序号</td><td>物品名称</td><td>日租</td></tr>
    <?php foreach($records as $row) : ?>
    <tr id="id<?php echo $row['idappendix'];?>">
	<td><?php echo $row['idappendix'];?></td>
